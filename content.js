 ...
 * 
 * Features:
 * 1. URL Gate: Immediately exits on home/landing pages.
 * 2. Privacy-Safe Audio Extraction: Uses vid.captureStream() with Web Audio API (AnalyserNode).
 * 3. Accurate DOM Scraping: Extracts participant display names from platform wrappers.
 * 4. Collapsible Multi-Speaker HUD (#df-wrapper, #df-toggle-btn, and #df-card-${safeId}).
 * 5. High-performance asynchronous frame streaming via ImageBitmap transfers.
 */

// ---------------------------------------------------------------------------
// 1. URL GATE - PREVENT INJECTION ON HOME/LANDING PAGES
// ---------------------------------------------------------------------------
    ...
    function getRemoteVideos() {
        ...
        for (const vid of videos) {
            if (vid.readyState >= 2 && vid.videoWidth > 0 && !vid.paused) {
                ...
                // Exclude local mirrored preview and small status thumbnails
